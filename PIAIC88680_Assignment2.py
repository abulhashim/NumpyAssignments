...
def function3():
    ...
    x = a[np.logical_and(a % 5 == 0 , a % 7 == 0)] #write your code here
    return x
...
def function5():
    ...
    z = np.zeros((4,5),dtype=int) #write your code here
    return z
...
def function6():
    ...
    arr = np.zeros(10,dtype=int) #write your code here
    arr[[4,7]] = [10,20]
    return arr
...
def function8():
    ...
    x = np.array(6,dtype=np.int32).repeat(10).reshape(2,5) #write your code here
    return x
